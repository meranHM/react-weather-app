    ...
    const hourlyElements = hourlyData.map((data, index) => {
      ...
      return (
        ...
        >
          ...
          <p className="text-center">{data.temp_c}</p>
          <p className="flex items-center text-center mt-1 gap-1">
